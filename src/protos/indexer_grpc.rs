...
const METHOD_INDEXER_COUNT: ::grpcio::Method<
    super::indexer::CountRequest,
    super::indexer::CountResponse,
> = ::grpcio::Method {
...
const METHOD_INDEXER_QUERY: ::grpcio::Method<
    super::indexer::QueryRequest,
    super::indexer::QueryResponse,
> = ::grpcio::Method {
    ty: ::grpcio::MethodType::Unary,
...
const METHOD_INDEXER_BIND: ::grpcio::Method<super::indexer::BindRequest, super::common::Error> =
    ::grpcio::Method {
        ty: ::grpcio::MethodType::Unary,
...
const METHOD_INDEXER_UN_BIND: ::grpcio::Method<
    super::indexer::UnBindRequest,
    super::common::Error,
> = ::grpcio::Method {
    ty: ::grpcio::MethodType::Unary,
...
impl IndexerClient {
    ...
    pub fn count_opt(
        &self,
        req: &super::indexer::CountRequest,
        opt: ::grpcio::CallOption,
    ) -> ::grpcio::Result<super::indexer::CountResponse> {
    ...
    pub fn count_async_opt(
        &self,
        req: &super::indexer::CountRequest,
        opt: ::grpcio::CallOption,
    ) -> ::grpcio::Result<::grpcio::ClientUnaryReceiver<super::indexer::CountResponse>> {
        self.client
            .unary_call_async(&METHOD_INDEXER_COUNT, req, opt)
    }
    ...
    pub fn query_opt(
        &self,
        req: &super::indexer::QueryRequest,
        opt: ::grpcio::CallOption,
    ) -> ::grpcio::Result<super::indexer::QueryResponse> {
    ...
    pub fn query_async_opt(
        &self,
        req: &super::indexer::QueryRequest,
        opt: ::grpcio::CallOption,
    ) -> ::grpcio::Result<::grpcio::ClientUnaryReceiver<super::indexer::QueryResponse>> {
        self.client
            .unary_call_async(&METHOD_INDEXER_QUERY, req, opt)
    }
    ...
    pub fn un_bind_opt(
        &self,
        req: &super::indexer::UnBindRequest,
        opt: ::grpcio::CallOption,
    ) -> ::grpcio::Result<super::common::Error> {
    ...
    pub fn un_bind_async_opt(
        &self,
        req: &super::indexer::UnBindRequest,
        opt: ::grpcio::CallOption,
    ) -> ::grpcio::Result<::grpcio::ClientUnaryReceiver<super::common::Error>> {
        self.client
            .unary_call_async(&METHOD_INDEXER_UN_BIND, req, opt)
    }

    pub fn un_bind_async(
        &self,
        req: &super::indexer::UnBindRequest,
    ) -> ::grpcio::Result<::grpcio::ClientUnaryReceiver<super::common::Error>> {
...
pub trait Indexer {
    fn count(
        ...
        req: super::indexer::CountRequest,
        sink: ::grpcio::UnarySink<super::indexer::CountResponse>,
    );
    fn query(
        &mut self,
        ctx: ::grpcio::RpcContext,
        req: super::indexer::QueryRequest,
        sink: ::grpcio::UnarySink<super::indexer::QueryResponse>,
    );
    fn bind(
        &mut self,
        ctx: ::grpcio::RpcContext,
