...
const METHOD_COORDINATOR_SELECT: ::grpcio::Method<super::coordinator::SelectRequest, super::coordinator::SelectResponse> = ::grpcio::Method {
...
const METHOD_COORDINATOR_INSERT: ::grpcio::Method<super::coordinator::InsertRequest, super::common::Error> = ::grpcio::Method {
    ty: ::grpcio::MethodType::Unary,
...
const METHOD_COORDINATOR_UPDATE: ::grpcio::Method<super::coordinator::UpdateRequest, super::common::Error> = ::grpcio::Method {
    ty: ::grpcio::MethodType::Unary,
...
const METHOD_COORDINATOR_DELETE: ::grpcio::Method<super::coordinator::DeleteRequest, super::common::Error> = ::grpcio::Method {
    ty: ::grpcio::MethodType::Unary,
...
impl CoordinatorClient {
    ...
    pub fn select_opt(&self, req: &super::coordinator::SelectRequest, opt: ::grpcio::CallOption) -> ::grpcio::Result<super::coordinator::SelectResponse> {
        self.client.unary_call(&METHOD_COORDINATOR_SELECT, req, opt)
    }

    pub fn select(&self, req: &super::coordinator::SelectRequest) -> ::grpcio::Result<super::coordinator::SelectResponse> {
        self.select_opt(req, ::grpcio::CallOption::default())
    }

    pub fn select_async_opt(&self, req: &super::coordinator::SelectRequest, opt: ::grpcio::CallOption) -> ::grpcio::Result<::grpcio::ClientUnaryReceiver<super::coordinator::SelectResponse>> {
        self.client.unary_call_async(&METHOD_COORDINATOR_SELECT, req, opt)
    }

    pub fn select_async(&self, req: &super::coordinator::SelectRequest) -> ::grpcio::Result<::grpcio::ClientUnaryReceiver<super::coordinator::SelectResponse>> {
        self.select_async_opt(req, ::grpcio::CallOption::default())
    }

    pub fn insert_opt(&self, req: &super::coordinator::InsertRequest, opt: ::grpcio::CallOption) -> ::grpcio::Result<super::common::Error> {
        self.client.unary_call(&METHOD_COORDINATOR_INSERT, req, opt)
    }

    pub fn insert(&self, req: &super::coordinator::InsertRequest) -> ::grpcio::Result<super::common::Error> {
        self.insert_opt(req, ::grpcio::CallOption::default())
    }

    pub fn insert_async_opt(&self, req: &super::coordinator::InsertRequest, opt: ::grpcio::CallOption) -> ::grpcio::Result<::grpcio::ClientUnaryReceiver<super::common::Error>> {
        self.client.unary_call_async(&METHOD_COORDINATOR_INSERT, req, opt)
    }

    pub fn insert_async(&self, req: &super::coordinator::InsertRequest) -> ::grpcio::Result<::grpcio::ClientUnaryReceiver<super::common::Error>> {
        self.insert_async_opt(req, ::grpcio::CallOption::default())
    }

    pub fn update_opt(&self, req: &super::coordinator::UpdateRequest, opt: ::grpcio::CallOption) -> ::grpcio::Result<super::common::Error> {
        self.client.unary_call(&METHOD_COORDINATOR_UPDATE, req, opt)
    }

    pub fn update(&self, req: &super::coordinator::UpdateRequest) -> ::grpcio::Result<super::common::Error> {
        self.update_opt(req, ::grpcio::CallOption::default())
    }

    pub fn update_async_opt(&self, req: &super::coordinator::UpdateRequest, opt: ::grpcio::CallOption) -> ::grpcio::Result<::grpcio::ClientUnaryReceiver<super::common::Error>> {
        self.client.unary_call_async(&METHOD_COORDINATOR_UPDATE, req, opt)
    }

    pub fn update_async(&self, req: &super::coordinator::UpdateRequest) -> ::grpcio::Result<::grpcio::ClientUnaryReceiver<super::common::Error>> {
        self.update_async_opt(req, ::grpcio::CallOption::default())
    }

    pub fn delete_opt(&self, req: &super::coordinator::DeleteRequest, opt: ::grpcio::CallOption) -> ::grpcio::Result<super::common::Error> {
        self.client.unary_call(&METHOD_COORDINATOR_DELETE, req, opt)
    }

    pub fn delete(&self, req: &super::coordinator::DeleteRequest) -> ::grpcio::Result<super::common::Error> {
        self.delete_opt(req, ::grpcio::CallOption::default())
    }

    pub fn delete_async_opt(&self, req: &super::coordinator::DeleteRequest, opt: ::grpcio::CallOption) -> ::grpcio::Result<::grpcio::ClientUnaryReceiver<super::common::Error>> {
        self.client.unary_call_async(&METHOD_COORDINATOR_DELETE, req, opt)
    }

    pub fn delete_async(&self, req: &super::coordinator::DeleteRequest) -> ::grpcio::Result<::grpcio::ClientUnaryReceiver<super::common::Error>> {
...
pub trait Coordinator {
    fn select(&mut self, ctx: ::grpcio::RpcContext, req: super::coordinator::SelectRequest, sink: ::grpcio::UnarySink<super::coordinator::SelectResponse>);
    fn insert(&mut self, ctx: ::grpcio::RpcContext, req: super::coordinator::InsertRequest, sink: ::grpcio::UnarySink<super::common::Error>);
    fn update(&mut self, ctx: ::grpcio::RpcContext, req: super::coordinator::UpdateRequest, sink: ::grpcio::UnarySink<super::common::Error>);
    fn delete(&mut self, ctx: ::grpcio::RpcContext, req: super::coordinator::DeleteRequest, sink: ::grpcio::UnarySink<super::common::Error>);
