...
class IndexerStub(object):
    ...
    def __init__(self, channel):
        ...
        self.Count = channel.unary_unary(
                '/protos.Indexer/Count',
                request_serializer=indexer__pb2.CountRequest.SerializeToString,
                response_deserializer=indexer__pb2.CountResponse.FromString,
                )
        self.Query = channel.unary_unary(
                '/protos.Indexer/Query',
                request_serializer=indexer__pb2.QueryRequest.SerializeToString,
                response_deserializer=indexer__pb2.QueryResponse.FromString,
                )
...
def add_IndexerServicer_to_server(servicer, server):
    rpc_method_handlers = {
            'Count': grpc.unary_unary_rpc_method_handler(
                    servicer.Count,
                    request_deserializer=indexer__pb2.CountRequest.FromString,
                    response_serializer=indexer__pb2.CountResponse.SerializeToString,
            ),
            'Query': grpc.unary_unary_rpc_method_handler(
                    servicer.Query,
                    request_deserializer=indexer__pb2.QueryRequest.FromString,
                    response_serializer=indexer__pb2.QueryResponse.SerializeToString,
            ),
...
class Indexer(object):
    ...
    def Count(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/protos.Indexer/Count',
            indexer__pb2.CountRequest.SerializeToString,
            indexer__pb2.CountResponse.FromString,
    ...
    def Query(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/protos.Indexer/Query',
            indexer__pb2.QueryRequest.SerializeToString,
            indexer__pb2.QueryResponse.FromString,
            options, channel_credentials,
            call_credentials, compression, wait_for_ready, timeout, metadata)
