...
_QUERYREQUEST = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='table', full_name='protos.QueryRequest.table', index=0,
    ...
    _descriptor.FieldDescriptor(
      name='query', full_name='protos.QueryRequest.query', index=1,
...
_QUERYRESPONSE = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='rows', full_name='protos.QueryResponse.rows', index=0,
...
_COUNTREQUEST = _descriptor.Descriptor(
  name='CountRequest',
  full_name='protos.CountRequest',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='table', full_name='protos.CountRequest.table', index=0,
      number=1, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=b"".decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='query', full_name='protos.CountRequest.query', index=1,
      number=2, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=b"".decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_COUNTRESPONSE = _descriptor.Descriptor(
  name='CountResponse',
  full_name='protos.CountResponse',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='result', full_name='protos.CountResponse.result', index=0,
...
_QUERYRESPONSE.fields_by_name['rows'].message_type = common__pb2._ROW
...
CountRequest = _reflection.GeneratedProtocolMessageType('CountRequest', (_message.Message,), {
  ...
  '__module__' : 'indexer_pb2'
  # @@protoc_insertion_point(class_scope:protos.CountRequest)
  })
...
CountResponse = _reflection.GeneratedProtocolMessageType('CountResponse', (_message.Message,), {
  ...
  '__module__' : 'indexer_pb2'
  # @@protoc_insertion_point(class_scope:protos.CountResponse)
  })
...
_INDEXER = _descriptor.ServiceDescriptor(
  ...
  _descriptor.MethodDescriptor(
    name='Count',
    full_name='protos.Indexer.Count',
    index=0,
  ...
  _descriptor.MethodDescriptor(
    name='Query',
    full_name='protos.Indexer.Query',
    index=1,
    containing_service=None,
