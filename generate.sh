...
protoc -I./protos --rust_out=./components/workers/src/protos --grpc_out=./components/workers/src/protos --plugin=protoc-gen-grpc=`which grpc_rust_plugin` ./protos/indexer.proto ./protos/packer.proto ./protos/common.proto
